...
const getBalance = (principal, latestIndex, latestRate, latestUpdateTimestamp, timestamp) =>
  getPresentAmountRoundedDown(principal, getCurrentIndex(latestIndex, latestRate, latestUpdateTimestamp, timestamp));
